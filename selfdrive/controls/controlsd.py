...
class Controls:
  ...
  def state_control(self, CS):
    ...
    if not self.joystick_mode:
      ...
      if len(lat_plan.curvatures) > 0: # remnav
        self.desired_curvature = lat_plan.curvatures[0] #remnav
      if len(lat_plan.curvatureRates) > 0: #remanv
        self.desired_curvature_rate = lat_plan.curvatureRates[0] #remnav
