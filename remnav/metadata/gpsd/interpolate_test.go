...
func TestInterval(t *testing.T) {
	...
	pos, index = Interpolate(tpvs[:1], inline("2022-10-01T12:00:00Z"), 1)
	checkWantNil(t, "one TPV, late start", pos, index)
	...
	pos, index = Interpolate(tpvs[:2], inline("2022-10-01T12:00:21Z"), 1)
	checkWantNil(t, "late start, 2 TPV", pos, index)
	...
	checkWant(t, "interpolate, 0/2 interval, end, 3 TPV", Position{Time: inline("2022-10-01T12:00:20Z"),
		Lat: 20, Lon: -200, Speed: 2}, 0, pos, index)
	pos, index = Interpolate(tpvs[:3], inline("2022-10-01T12:00:20Z"), 1)
	checkWant(t, "interpolate, 0/2 interval, end, non-zero start, 3 TPV", Position{Time: inline("2022-10-01T12:00:20Z"),
		Lat: 20, Lon: -200, Speed: 2}, 1, pos, index)

	pos, index = Interpolate(tpvs[:3], inline("2022-10-01T12:00:24Z"), 0)
	...
	pos, index = Interpolate(tpvs[:3], inline("2022-10-01T12:00:30Z"), 0)
	...
	checkWant(t, "interpolate, 1/2 interval, mid, non-zero start, 3 TPV", Position{Time: inline("2022-10-01T12:00:24Z"),
		Lat: 24, Lon: -240, Speed: 2.4}, 1, pos, index)
	pos, index = Interpolate(tpvs[:3], inline("2022-10-01T12:00:30Z"), 1)
	checkWant(t, "interpolate, 1/2 interval, end, non-zero start, 3 TPV", Position{Time: inline("2022-10-01T12:00:30Z"),
		Lat: 30, Lon: -300, Speed: 3}, 1, pos, index)
